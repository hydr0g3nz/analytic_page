              ...
              <b-row>
                ...
                <b-col cols="6">
                  <my-legend :num="2" :color="['rgb(235,129,35)', 'rgb(237,237,237)']">
                    <template v-slot:1>ผู้เรียนที่เรียนจบ{{legendValue[0]}} คน</template>
                    <template v-slot:2>ผู้เรียนที่เรียนยังไม่จบ {{legendValue[1]}} คน</template>
                  </my-legend>
                </b-col>
              </b-row>
            </div>
