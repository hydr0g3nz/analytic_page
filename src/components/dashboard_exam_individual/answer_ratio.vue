...
export default {
  ...
  methods: {
    fillData() {
      ...
      this.datacollection = {
        labels: [
          `ข้อถูก ${((data[0] * 100) / randomdata.sum).toFixed(2)}%`,
         `ข้อผิด ${((data[1] * 100) / randomdata.sum).toFixed(2)}%`,
         `ไม่ตอบ ${((data[2] * 100) / randomdata.sum).toFixed(2)}%`,
        ],
        datasets: [
          {
            label: "Point",
            backgroundColor: ["rgb(255,190,79)", "rgb(237,164,38)","rgb(255,219,157)"],
